...
describe 'plexmediaserver', :type => :class do
  ...
  context "on a CentOS 32-bit system" do
    ...
    it { should contain_staging__file('plexmediaserver-1.13.2.5154-fd05be322.i386.rpm') }
  end
  ...
  context "on a CentOS 64-bit system" do
    ...
    it { should contain_staging__file('plexmediaserver-1.13.2.5154-fd05be322.x86_64.rpm') }
  end
  ...
  context "on a Darwin system" do
    ...
    it { should contain_staging__deploy('PlexMediaServer-1.13.2.5154-fd05be322-OSX.zip') }
  end
  ...
  context "on a Ubuntu 32-bit system" do
    ...
    it { should contain_staging__file('plexmediaserver_1.13.2.5154-fd05be322_i386.deb') }
  end
  ...
  context "on a Ubuntu 64-bit system" do
    ...
    it { should contain_staging__file('plexmediaserver_1.13.2.5154-fd05be322_amd64.deb') }
  end
